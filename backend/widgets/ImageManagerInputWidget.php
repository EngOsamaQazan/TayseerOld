...
use noam148\imagemanager\components\ImageManagerInputWidget as BaseManagerInputWidget;
...
use backend\assets\ImageManagerInputAsset;


class ImageManagerInputWidget extends BaseManagerInputWidget {


    public $groupName = false;
    public $contractId = false;
    ...
    public function run() {
        ...
        $field .= "<a href='#' class='input-group-addon btn btn-primary open-modal-imagemanager' data-aspect-ratio='" . $this->aspectRatio . "' data-crop-view-mode='" . $this->cropViewMode . "' data-input-id='" . $sFieldId . "' data-group-name = '" . $this->groupName . "' data-contract-id = '" . $this->contractId . "'>";

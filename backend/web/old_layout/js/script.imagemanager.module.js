	...
	pickImage: function(){
		...
		switch(imageManagerModule.selectType){
			...
			case "input":
				...
				$('#contracts-selected_image', window.parent.document).val(imageManagerModule.selectedImage.id);
				$('#customers-selected_image', window.parent.document).val(imageManagerModule.selectedImage.id);

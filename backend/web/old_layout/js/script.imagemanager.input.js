var imageManagerInput = {
	...
	openModal: function(inputId, aspectRatio, cropViewMode, groupName, contractId){
		//get selected item
		...
		var imageManagerUrl = imageManagerInput.baseUrl+queryStringStartCharacter+"view-mode=iframe&input-id="+inputId+"&aspect-ratio="+aspectRatio+"&crop-view-mode="+cropViewMode+"&group-name="+groupName+"&contract-id="+contractId+srcImageIdQueryString;
		//set iframe path
...
$(document).ready(function () {
	...
	$(document).on("click", ".open-modal-imagemanager", function () {
		...
		//open selector id
		imageManagerInput.openModal(inputId, aspectRatio, cropViewMode, groupName, contractId);
	});	

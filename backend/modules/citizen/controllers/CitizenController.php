...
namespace backend\modules\citizen\controllers;

use Yii;
use backend\modules\citizen\models\Citizen;
use backend\modules\citizen\models\CitizenSearch;
...
class CitizenController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Citizen",
                    'content'=>'<span class="text-success">Create Citizen success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Citizen model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Citizen model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed

...
/**
 * ShareholdersController implements the CRUD actions for Shareholders model.
 */
class ShareholdersController extends Controller
{
    ...
    /**
     * Displays a single Shareholders model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new Shareholders model.
    ...
    /**
     * Updates an existing Shareholders model.
    ...
    /**
     * Deletes an existing Shareholders model.
    ...
    /**
     * Finds the Shareholders model based on its primary key value.

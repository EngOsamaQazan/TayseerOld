...
namespace backend\modules\feelings\controllers;

use Yii;
use backend\modules\feelings\models\Feelings;
use backend\modules\feelings\models\FeelingsSeacrch;
...
class FeelingsController extends Controller
{
    ...
    {    
        $searchModel = new FeelingsSeacrch();
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Feelings",
                    'content'=>'<span class="text-success">Create Feelings success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Feelings model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Feelings model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed

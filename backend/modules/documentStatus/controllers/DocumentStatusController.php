...
namespace backend\modules\documentStatus\controllers;

use Yii;
use backend\modules\documentStatus\models\DocumentStatus;
use backend\modules\documentStatus\models\DocumentStatusSearch;
...
class DocumentStatusController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new DocumentStatus",
                ...
                return [
                    ...
                    'title'=> "Create new DocumentStatus",
                    'content'=>'<span class="text-success">Create DocumentStatus success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update DocumentStatus #".$id,
    ...
    /**
     * Delete an existing DocumentStatus model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing DocumentStatus model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed

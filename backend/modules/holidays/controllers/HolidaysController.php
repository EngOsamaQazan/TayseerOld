...
namespace backend\modules\holidays\controllers;

use Yii;
use backend\modules\holidays\models\Holidays;
use backend\modules\holidays\models\HolidaysSearch;
...
class HolidaysController extends Controller
{
    ...
    public function actionExportExcel()
    {
        ...
        return $this->exportData($dataProvider, [
            'title'    => 'العطل الرسمية',
            'filename' => 'holidays',
            'headers'  => ['#', 'العنوان', 'تاريخ البداية', 'تاريخ النهاية', 'أنشأ بواسطة'],
            'keys'     => ['#', 'title', 'start_at', 'end_at', 'createdBy.username'],
            'widths'   => [8, 25, 18, 18, 20],
        ], 'excel');
    }
    ...
    /**
     * Delete an existing Holidays model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing Holidays model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed

...
/**
 * LeavePolicySearch represents the model behind the search form about `common\models\LeavePolicy`.
 */
class LeavePolicySearch extends LeavePolicy
{
    /**
     * @inheritdoc
     */

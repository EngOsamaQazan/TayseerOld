...
namespace backend\modules\paymentType\controllers;

use Yii;
use backend\modules\paymentType\models\PaymentType;
use backend\modules\paymentType\models\PaymentTypeSeacrch;
...
class PaymentTypeController extends Controller
{
    ...
    {    
        $searchModel = new PaymentTypeSeacrch();
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new PaymentType",
                    'content'=>'<span class="text-success">Create PaymentType success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing PaymentType model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing PaymentType model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed

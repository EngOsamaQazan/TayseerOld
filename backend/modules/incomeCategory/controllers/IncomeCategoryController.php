...
namespace backend\modules\incomeCategory\controllers;

use Yii;
use backend\modules\incomeCategory\models\IncomeCategory;
use backend\modules\incomeCategory\models\IncomeCategorySearch;
...
class IncomeCategoryController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new IncomeCategory",
                ...
                return [
                    ...
                    'title'=> "Create new IncomeCategory",
                    'content'=>'<span class="text-success">Create IncomeCategory success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update IncomeCategory #".$id,
    ...
    /**
     * Delete an existing IncomeCategory model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing IncomeCategory model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed

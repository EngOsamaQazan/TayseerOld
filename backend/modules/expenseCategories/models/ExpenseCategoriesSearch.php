...
/**
 * ExpenseCategoriesSearch represents the model behind the search form about `common\models\ExpenseCategories`.
 */
class ExpenseCategoriesSearch extends ExpenseCategories
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'name', $this->name])
            ->andFilterWhere(['like', 'description', $this->description])->where(['is_deleted' => false]);

...
<div id="module-imagemanager" class="container-fluid <?=$selectType?>">
	<div class="row">
		...
		<div class="col-xs-6 col-sm-2 col-options">
			...
			<?php
                // if (Yii::$app->controllers->module->canUploadImage):
                    if(Yii::$app->getModule('imagemanager')->canUploadImage):
			?>
			...
			<?=FileInput::widget([
				...
				'pluginOptions' => [
					'uploadUrl' => Url::to(['/imagemanager/upload']),
			...
			<div class="image-info hide">
				...
				<div class="details">
					...
					<?php
						if (Yii::$app->getModule('imagemanager')->canRemoveImage):
					?>

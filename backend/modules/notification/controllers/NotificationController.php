...
class NotificationController extends Controller
{
        ...
        return [
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'allow' => true,
                        'actions' => ['logout', 'index', 'update', 'create', 'delete', 'is-read', 'msg', 'see-all-msg'],
                        'roles' => ['@'],
                    ],
                ],
            ],
    ...
    public function actionIsRead()
    {
        ...
        Notification::updateAll(['is_unread' => 0], ['recipient_id' => Yii::$app->user->id]);
    }

    public function actionSeeAllMsg()
    {
        $searchModel = new NotificationSearch();
        $dataProvider = $searchModel->allUserMsg(Yii::$app->request->queryParams);
        Notification::updateAll(['is_unread' => 0], ['recipient_id' => Yii::$app->user->id]);
        return $this->render('_all-user-msg', [
            'dataProvider' => $dataProvider,

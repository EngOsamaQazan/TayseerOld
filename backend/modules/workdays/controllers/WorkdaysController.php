...
namespace backend\modules\workdays\controllers;

use Yii;
use  backend\modules\workdays\models\Workdays;
use  backend\modules\workdays\models\WorkdaysSearch;
...
class WorkdaysController extends Controller
{
    ...
    /**
     * Delete an existing Workdays model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing Workdays model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed

...
class Employee extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['username'], 'unique'],
            [['email'], 'unique'],
            [['job_title'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\modules\designation\models\Designation::className(), 'targetAttribute' => ['job_title' => 'id']],
            [['reporting_to'], 'exist', 'skipOnError' => true, 'targetClass' => Employee::className(), 'targetAttribute' => ['reporting_to' => 'id']],
            [['department'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\modules\department\models\Department::className(), 'targetAttribute' => ['department' => 'id']],
            [['location'], 'exist', 'skipOnError' => true, 'targetClass' =>  \backend\modules\location\models\Location::className(), 'targetAttribute' => ['location' => 'id']],
        ];
    }
